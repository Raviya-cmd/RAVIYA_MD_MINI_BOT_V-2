...
const octokit = new Octokit({ auth: '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' });// ඔයා 𝚐𝚒𝚝𝚑𝚞𝚋 𝚝𝚘𝚔𝚎𝚗 එකක් අරන් ඒක දාන්න
const owner = 'Raviya-cmd';//𝚐𝚒𝚝𝚑𝚞𝚋 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 එකේ 𝚞𝚜𝚎𝚗𝚊𝚖𝚎 දාන්න 
const repo = 'RAVIYA_MD_MINI_BOT_V-2';//𝚐𝚒𝚝𝚑𝚞𝚋 𝚛𝚎𝚙𝚘 එකක් හදලා ඒකේ නම දාන්න
